...
export default function MindfulnessScreen() {
  ...
  const handleToolPress = (toolId: string) => {
    ...
    switch (toolId) {
      case 'journal':
        router.push('/mindfulness/journal');
        break;
      case 'gratitude':
        router.push('/mindfulness/gratitude');
        break;
      case 'affirmations':
        router.push('/mindfulness/affirmations');
        break;
      case 'focus-timer':
        router.push('/mindfulness/focus-timer');
        break;
      case 'breathe':
        router.push('/mindfulness/quick-breathe');
        break;
      case 'strengths':
        router.push('/mindfulness/strengths');
        break;
      default:
        break;
    }
      ...
      <LinearGradient colors={['#F0F4F8', '#DEF5FA']} style={styles.gradient}>
        ...
        <View style={styles.header}>
          <TouchableOpacity onPress={() => router.back()}>
            <ArrowLeft color="#1E3A5F" size={24} />
          </TouchableOpacity>
